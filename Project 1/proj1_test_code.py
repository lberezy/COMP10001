#
# Test harness for COMP10001 Project 1, 2013s1
#
# Author: Tim Baldwin
#
# Date: 25/3/13
...
try:
    ...
    tests = __import__(code + "-tests")  # import the file `USERNAME.py`
...
# exit if one of the above statements doesn't execute properly, presumably because `USERNAME.py` and `USERNAME-tests.py` didn't import properly
    ...
    print("ERROR: Make sure you run the code in the directory where your solution is, and that it and your test cases are named correctly")
    sys.exit()
